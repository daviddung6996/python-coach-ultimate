...
1. Call validate_user_data() to validate the inputs.
2. Check whether the email already exists in the registered_users list.
3. If a duplicate email is found, raise a ValueError.
